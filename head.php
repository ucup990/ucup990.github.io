...
<body>
	...
	<div class="sidebar">
		<h3><i class="fa fa fa-shopping-cart"></i> Fresh Mart</h3>
		<ul>
			<?php
			if ($_SESSION['status'] == 1) {
			?>
				<li class="admin-info">
					<img src="assets/img/hai.jpg">
				...
				<li><a id="users" href="users.php"><i class="fa fa-users"></i> Petani</a></li>
				<li><a id="pembeli" href="pembeli.php"><i class="fa fa-user"></i> Pembeli</a></li>
			...
			?>
				<li><a id="Home" href="indexx.php"><i class="fa fa-user"></i> Dashboard</a></li>
			<?php
			}
			?>
		</ul>
