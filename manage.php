	...
	if (isset($_POST['sub'])) {
		...
		if (isset($_SESSION['cart'])) {
			...
			if (in_array($_POST['Iteamname'], $item)) {
				...
				// echo '<script>alert("The Item allredy added...); window.open("indexx.php","_blabk");</script>';
			...
			//echo '<script>alert("The Item  added.. Sucessfully..."); window.open("indexx.php","_blank");</script>';
			echo "<script>alert('The Item  added.. Sucessfully...'); window.open('indexx.php' ,'_self');</script>";
		}
	}
